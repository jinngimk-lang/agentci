...
@pytest.mark.parametrize(
    ...
    [
        ...
        ('schemas/sandbox-execution-contract-v0alpha1.schema.json', 'contract-schema/sandbox-execution-contract-v0alpha1.schema.json'),
        ('schemas/sandbox-execution-route-observation-v0alpha1.schema.json', 'route-schema/sandbox-execution-route-observation-v0alpha1.schema.json'),
