...
def test_network_probe_requires_typed_exact_channel_evidence(monkeypatch):
    ...
    # Isolate the assertion/probe semantic check from execution-attestation identity,
    # which is already covered independently by the canonical #89 lineage.
    ...
    utility_event["event_type"] = "utility"
    _rebind_all(document)
