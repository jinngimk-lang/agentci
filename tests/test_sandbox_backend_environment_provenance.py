...
def test_pass_evidence_must_bind_exact_backend_and_environment_provenance():
    ...
    # Keep the canonical TestCase, probe, workload, policy and observed events
    # unchanged, but reinterpret those observations under a different backend
    # and environment. Recomputing envelope-local digests must not be enough to
    # turn old observations into evidence for the new execution provenance.
