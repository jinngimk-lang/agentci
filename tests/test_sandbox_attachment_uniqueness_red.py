...
from scripts.validate_sandbox_evidence import artifact_digest, authority_binding_digest, event_semantic_digest, expected_verdict
...
def test_pass_rejects_multiple_effective_attachments_for_same_workload_and_epoch():
    ...
    second_provenance = {
        "event_id": "event-policy-attachment-ambiguous", "event_type": "policy-attachment",
        "occurred_at_utc": "2026-08-11T03:00:00Z", "monotonic_ns": 1550,
        "policy_epoch": 0, "authority_epoch": 0, "source_id": "fixture-policy-observer",
        "workload_identity": "fixture-workload", "attachment_id": "attach-2",
    }
